...
client.once('ready', async () => {
    ...
    console.log('🔄 Approbation de babaaa...\n');
    ...
    try {
        console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
        console.log(`📋 Traitement de : babaaa`);

        // Attendre 30 secondes pour éviter le rate limit
        console.log('⏳ Attente de 30s pour éviter le rate limit Discord...');
        ...
        const member = members.find(m =>
            m.user.tag === "babaaa" ||
            m.user.username === "babaaa" ||
            m.user.globalName === "babaaa"
        );

        if (!member) {
            console.log(`⚠️ Membre "babaaa" non trouvé sur le serveur.`);
            process.exit(1);
        }
        ...
        console.log(`✅ babaaa approuvé avec succès !`);
