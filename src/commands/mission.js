        ...
        if (subcommand === 'create') {
            ...
            if (!userData) {
                ...
                if (hasRole) {
                    ...
                    return interaction.reply({ embeds: [embeds.error('Accès refusé', 'Tu dois être membre (Rookie+) pour prendre des missions. Ton ticket a été créé à ton arrivée — remplis ta candidature.')], ephemeral: true });
                }
            }
